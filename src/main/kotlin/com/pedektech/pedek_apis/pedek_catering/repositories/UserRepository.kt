...
interface UserRepository : JpaRepository<User, Long> {
    ...
    // New method to find users by access device (MAC address)
    fun findByAccessDevice(accessDevice: String): List<User>

    // Method to check if a device exists in any account
    fun existsByAccessDevice(accessDevice: String): Boolean
}